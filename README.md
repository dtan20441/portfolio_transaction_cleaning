...
## Overview
This portfolio project aims to demonstrate cleaning dirty financial transaction data using Python from a dummy company where each row represents a transaction made by the company.     
